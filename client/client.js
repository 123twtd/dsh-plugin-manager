window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const css = `
      ...
      .dshpm-button.primary{background:var(--dsw-alias-brand-primary);color:var(--dsw-alias-label-primary-foreground);border-color:var(--dsw-alias-brand-primary)}.dshpm-button.primary:hover{color:var(--dsw-alias-label-primary-foreground);filter:brightness(1.06)}
